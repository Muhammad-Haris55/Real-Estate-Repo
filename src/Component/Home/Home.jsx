    ...
    <>
          ...
          <div className="row g-5">
            <div className="col-lg-4 col-md-6">
              <div className="mb-3">
                ...
                <h1 className="display-6" style={{ fontweight: "500" }}>
                  Pioneer Of Modern Building Company
                </h1>
              </div>
              <p className="mb-4">
                Welcome to our estate marketing and building services! At our
                core, we specialize in property management, construction, and
                real estate solutions.
              </p>
              <a
                style={{ background: "maroon", color: "white" }}
                href=""
                className="btn  py-md-3 px-md-5"
              >
                Contact Us
              </a>
            </div>
            <div className="col-lg-4 col-md-6">
              <div className="service-item bg-light text-center p-5">
                ...
                <p className="mb-0">
                  Efficient commercial property management, optimizing assets.
                </p>
              </div>
            </div>
            <div className="col-lg-4 col-md-6">
              <div className="service-item bg-light text-center p-5">
                ...
                <h4>Houses</h4>
                <p className="mb-0">
                  Exemplary house building and construction services await.
                </p>
              </div>
            </div>
            <div className="col-lg-4 col-md-6">
              <div className="service-item bg-light text-center p-5">
                ...
                <h4>Plots</h4>
                <p className="mb-0">
                  Streamlining seamless plot sales and purchases.
                </p>
              </div>
            </div>
            <div className="col-lg-4 col-md-6">
              <div className="service-item bg-light text-center p-5">
                ...
                <p className="mb-0">
                  We deliver excellence, from property acquisition to
                  construction.
                </p>
              </div>
            </div>
            <div className="col-lg-4 col-md-6">
              <div className="service-item bg-light text-center p-5">
                ...
                <p className="mb-0">
                  Find the perfect commercial or residential property to suit
                  your lifestyle.
                </p>
              </div>
            </div>
            ...
            <div className="col-md-6">
              <div className="project_main">
                ...
                <p className="services_text">
                  ...
                  by the readable content of a Lorem ipsum dolor sit amet
                  consectetur adipisicing elit. Molestias nisi consequatur culpa
                  qui mollitia quam officia eos vero quos, delectus repellendus,
                  quo consequuntur cumque omnis est illum, quia vel voluptates?
                </p>
        ...
        <div className="container">
          <div className="row g-5 align-items-center">
            ...
            <div className="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
              ...
              >
                Join Us As We Bring Real Estate Visionaries To The Forefront.
              </h1>
              <p className="mb-4">
              ...
              <p>
                <i className="fa fa-check text-dark me-3"></i>Explore Real
                Estate Trends: Stay updated with the most recent trends and
                developments in the real estate industry.
              </p>
              <p>
                <i className="fa fa-check text-dark me-3"></i>Meet Visionaries:
                Connect with real estate entrepreneurs and marketing experts who
                are shaping the future of the field.
              </p>
              <p>
                <i className="fa fa-check text-dark me-3"></i>Your Real Estate
                Resource: HR Talks by HR Estate and Builders is your trusted
                resource for all things real estate and marketing.
              </p>
      ...
      <div>
        ...
        <div className="col-lg-6 mx-auto">
          ...
          >
            A Dream Real Estate Brand Packed With Potential and Results
          </p>
        </div>
        <div style={{ margin: "50px" }}>
          ...
          >
            <div
              className="col-md-6 col-sm-12 order-md-3"
              style={{ flex: "1 0 50%;" }}
            >
              {" "}
              <h1
              ...
              >
                C-23 Gulistan e Rafi, Malir City, Karachi{" "}
              </p>
            </div>
            <div
              className="col-md-5 col-sm-12 order-md-1"
              style={{ flex: "1 0 50%" }}
            >
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d572.7379905504937!2d67.18867214275399!3d24.876970359817253!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3eb339a1c6d30ea7%3A0x3034dc0ab3319dad!2sAhmed%20%26%20Rehman%20Builders%20%26%20Developers!5e0!3m2!1sen!2sus!4v1708529326069!5m2!1sen!2sus"
                style={{
                  border: "0",
                  width: "100%",
                  height: "60vh",
